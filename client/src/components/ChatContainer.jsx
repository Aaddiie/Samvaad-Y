  ...
  const interval = setInterval(() => {
    getMessages(selectedUser._id);  // any function that fetches data again
  ...
  return () => clearInterval(interval);
        ...
        <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
          ...
          {messages?.map((msg, index) => (
            ...
            > 
              ...
              <p className='text-gray-500'>{formateMessageTime( msg.createdAt)}</p> </div>
            </div>
          ))}
          <div ref={scrollend}>
    ...
    <div className="absolute bottom-0 left-0 right-0 p-3 gap-3 flex items-center">
      <div className="flex-1 flex items-center bg-gray100/12 px-3 rounded-full">
        ...
        <input onChange = {handelSendImage} type="file" id="image" accept="image/jpg, image/png" hidden/>
        <label htmlFor="image">
